...
+NOTE+: the original project ("multi_progress_bar"), which doesn't work, is abandoned; this project ("multi_progress_bar2") uses a fixed version of the ncurses dependency ("ffi-ncurses2" in place of "ncurses"), allowing it to run as intended.
